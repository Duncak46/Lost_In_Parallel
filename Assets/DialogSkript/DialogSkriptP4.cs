...
public class DialogSkriptP4 : MonoBehaviour
{
    ...
    private string Text1HE = "Zdar! prodávám páku k automatu co jsem našel má docela velkou cenu a tak ji prodám za dvì mince....";
    private string Text2HE = "Takhle levná nebude";
    private string TextHeDone = "Tady ji máš, jsem zvìdavej na co ji potøebuješ";
