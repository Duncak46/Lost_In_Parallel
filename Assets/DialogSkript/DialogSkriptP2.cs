...
public class DialogSkriptP2 : MonoBehaviour
{
    ...
    private string Text1HE = "Ulovíš mi nìjaký ryby? Dám ti za to zvìrokruh.";
    private string Text2HE = "Tak co máš ty ryby?";
    private string TextHeDone = "Díky, tady máš odmìnu.";
